...
OSF.DDA.EventDispId = {
    ...
    dispidAppCommandInvokedEvent: 33,
...
OSF.InitializationHelper.prototype.prepareRightBeforeWebExtensionInitialize = function OSF_InitializationHelper$prepareRightBeforeWebExtensionInitialize(appContext) {
    ...
    OSF._OfficeAppFactory.setContext(new OSF.DDA.Context(appContext, appContext.doc, license, null, OSF.DDA.Theming.getOfficeTheme));
...
OSF.DDA.SafeArray.Delegate.ParameterMap.define({
    ...
    fromHost: [
        { name: OSF.DDA.DataNodeProperties, value: 0 },
        { name: OSF.DDA.DataNodeProperties, value: 1 },
        { name: OSF.DDA.DataNodeProperties, value: 2 },
        { name: OSF.DDA.DataNodeProperties, value: 3 }
    ],
    isComplexType: true
});
